...
<body style='' class="app sidebar-mini rtl">
   
<main style='min-height: calc(80vh - 50px);min-width: 80%; padding:25px;' class="app-content" id="app">
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header" style='text-align:center;' ><b>
 Change Password for security reasons </b></div>
                    ...
                    <form method="POST" action="{{ route('change.password') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                ...
                                <a class="btn btn-secondary" href="{{ route('login') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i>BACK</a>
                            </div>
                        </div>
                    </form>
                </div>
