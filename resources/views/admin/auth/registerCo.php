            ...
            <div class="tile">
                ...
                <form action="{{ route('admin.Employees.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="Company">Company Email <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('email') is-invalid @enderror" type="text" name="email" id="email" value="{{ old('email') }}"/>
                            @error('Company') {{ $message }} @enderror
                        </div>
                        <div class="form-group">
                            <textarea class="w3-input w3-large w3-round-large w3-margin-bottom" name="CompanyDescription" placeholder="Your Company Description" rows="6" cols="60" required></textarea>
