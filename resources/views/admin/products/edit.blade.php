                        ...
                        <form action="{{ route('admin.products.update') }}" method="POST" role="form">
                            ...
                            <div class="tile-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="categories[]" id="categories" class="form-control" multiple readOnly>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label" for="price">Budget</label>
                                            <input
                            ...
                            <div class="tile-footer">
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        <button class="btn btn-success" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update Project</button>
