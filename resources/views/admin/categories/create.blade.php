...
@section('content')
    <div class="app-title">
        <div>
            <h1><i class="fa fa-tags"></i>Project- {{ $pageTitle }}</h1>
        </div>
    </div>
            ...
            <div class="tile">
                ...
                <form action="{{ route('admin.categories.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <!-- <div class="form-group">
                            <label for="parent">Employee Department <span class="m-l-5 text-danger"> *</span></label>
                        ...
                        <!-- <div class="form-group">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" id="featured" name="featured"/>Featured Department
                                </label>
                            </div>
                        </div> -->
                        <!-- <div class="form-group">
                    ...
                    <div class="tile-footer">
                        <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save Employee Data</button>
                        &nbsp;&nbsp;&nbsp;
