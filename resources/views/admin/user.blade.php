...
<html>
   ...
   @include('site.Emplo.header')
    @include('site.Emplo.sidebar')
        ...
        <div class="row">
                <div class="col-md-4">
                    <div class="card card-body">
                        ...
                        <label style='margin-left:60px' class="" for=""><img width="150px" height="130px" src="{{ asset(Auth::user()->url) }}"></label>
                ...
                <div class="col-md-8">
                    <div class="card card-body">                        
                        <form class="form-layout form-layout-1" action="{{url('user_profiles')}}" method="POST" enctype="multipart/form-data">
                            @csrf
